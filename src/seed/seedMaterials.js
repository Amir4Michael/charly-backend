 ...
 *
 * ملاحظة: هذا السكربت يملأ أيضًا فجوة كانت موجودة من قبل — القوائم الأصلية
 * (fineness/packagingLoading) لم يكن لها أي Seed سابقًا، وكانت ستبدأ فارغة تمامًا في أي
 * قاعدة بيانات جديدة حتى يضيفها المدير يدويًا.
 *
 * ملاحظة بعد إعادة الهيكلة: فئتا rawTypes وpackagingProduction حُذفتا من هنا (ولم يعودا ضمن
 * MATERIAL_CATEGORIES في MaterialOption.js) لأن حقل "نوع الخامة" وقسم "الإنتاج والتعبئة"
 * أُلغيا بالكامل من التقرير اليومي.
 *
